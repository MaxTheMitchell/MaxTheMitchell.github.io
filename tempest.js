...
var $evancz$elm_playground$Playground$updateKeyboard = F3(
	function (isDown, key, keyboard) {
		var keys = isDown ? A2($elm$core$Set$insert, key, keyboard.g) : A2($elm$core$Set$remove, key, keyboard.g);
		switch (key) {
			case ' ':
				return _Utils_update(
					keyboard,
			...
			case 5:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							f: A3($evancz$elm_playground$Playground$mouseMove, x, y, computer.f)
						}));
			case 6:
				return A3(
					$evancz$elm_playground$Playground$Game,
					...
					_Utils_update(
						computer,
						{
							f: A2($evancz$elm_playground$Playground$mouseClick, true, computer.f)
						}));
			case 7:
				var isDown = msg.a;
				return A3(
					...
					_Utils_update(
						computer,
						{
							f: A2($evancz$elm_playground$Playground$mouseDown, isDown, computer.f)
						}));
			default:
	...
	function (keyboard, levelCount, player, enimies, bullets) {
		return A2(
			...
			A2(
				...
				function (b) {
					return $author$project$Characters$Bullet$isInBounds(b) && (!A2(
						$elm$core$List$any,
		...
		var realFunc = F2(
			function (perc, lines) {
				...
				while (true) {
					...
					if (_v0.$ === 1) {
						return A2($author$project$Shapes$Position$Position, 0, 0);
					} else {
						var head = _v0.a;
						if (_Utils_cmp(
...
var $author$project$Characters$Bullet$drawBullet = F4(
	function (screen, size, cPoly, bullet) {
...
var $author$project$Characters$Bullet$drawBullets = F4(
	function (screen, lineWidth, cPoly, bullets) {
		return $evancz$elm_playground$Playground$group(
			A2(
				$elm$core$List$map,
				A3($author$project$Characters$Bullet$drawBullet, screen, lineWidth, cPoly),
				bullets));
	});
